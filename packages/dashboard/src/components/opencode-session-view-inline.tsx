...
export function OpencodeSessionViewInline({ sessionName, opencodePort }: Props) {
  ...
  const fetchMessagesInitial = useCallback(async () => {
    ...
    try {
      ...
      // Scroll to bottom after render - use instant for no jarring animation
      setTimeout(() => {
      ...
      <header className="flex items-center gap-3 px-4 py-3 border-b border-neutral-800 bg-surface-1 shrink-0">
        <div className="relative flex-1" ref={dropdownRef}>
          <button
            ...
            className="w-full flex items-center justify-between gap-2 px-3 py-2 bg-surface-2 border border-neutral-700 rounded-lg text-sm text-white hover:border-neutral-600 transition-colors"
          >
